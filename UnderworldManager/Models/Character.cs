...
namespace UnderworldManager.Models
{
  public class Character
  {
    ...
    public int GetSkillTotal(Skill skill)
    {
      ...
      {
        case CoreAttribute.Strength:
          InitialValue = Strength.Total;
          break;
        case CoreAttribute.Intelligence:
          InitialValue = Intelligence.Total;
          break;
        case CoreAttribute.Agility:
          InitialValue = Agility.Total;
          break;
        case CoreAttribute.Charisma:
          InitialValue = Charisma.Total;
          break;
        default:
          throw new NotImplementedException();
      }
      ...
      {
        return InitialValue + SkillIncreases[skill].Increases;
      }
      else
        return InitialValue;
    }
    ...
    public (CoreAttribute, CoreAttribute) Get2DominantAttribute()
    {
      ...
      if (max1Type == CoreAttribute.Agility)
      {
        max2 = Math.Max(Strength.Total, Math.Max(Intelligence.Total, Charisma.Total));
      }
      if (max1Type == CoreAttribute.Intelligence)
      {
      ...
      CoreAttribute max2Type = Strength.Total == max2 && max1Type != CoreAttribute.Strength ? Strength.Type :
                        Agility.Total == max2 && max1Type != CoreAttribute.Agility ? Agility.Type :
                        Intelligence.Total == max2 && max1Type != CoreAttribute.Intelligence ? Intelligence.Type : Charisma.Type;
    ...
    public CoreAttribute GetDominantAttribute()
    {
      int maxValue = Math.Max(
              Math.Max(Strength.Total, Agility.Total),
              Math.Max(Intelligence.Total, Charisma.Total));

      int max1 = Math.Max(Math.Max(Strength.Total, Agility.Total),
  Math.Max(Intelligence.Total, Charisma.Total));
      CoreAttribute dominantAttribute = Strength.Total == max1 ? Strength.Type :
                        Agility.Total == max1 ? Agility.Type :
                        Intelligence.Total == max1 ? Intelligence.Type :
                        Charisma.Type;
      ...
      RoleList = new Dictionary<CoreAttribute, List<Rank1Roles>>
        {
            ...
            { CoreAttribute.Charisma, new List<Rank1Roles> { Rank1Roles.SmoothTalker, Rank1Roles.ConArtist, Rank1Roles.Negotiator, Rank1Roles.Prostitute } }
        };
    }
      ...
      Roles = new Dictionary<Tuple<CoreAttribute, CoreAttribute>, List<Rank2Roles>>
        {
            ...
            { new Tuple<CoreAttribute, CoreAttribute>(CoreAttribute.Intelligence, CoreAttribute.Charisma), new List<Rank2Roles> { Rank2Roles.Mastermind, Rank2Roles.Con_Artist, Rank2Roles.Negotiator, Rank2Roles.Diplomat } },
            { new Tuple<CoreAttribute, CoreAttribute>(CoreAttribute.Charisma, CoreAttribute.Intelligence), new List<Rank2Roles> { Rank2Roles.Mastermind, Rank2Roles.Con_Artist, Rank2Roles.Negotiator, Rank2Roles.Diplomat } }
        };
    }
