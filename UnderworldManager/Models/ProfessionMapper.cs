  ...
  public static class ProfessionMapper
  {
    ...
    public static string GetDescription(Profession job)
    {
      switch (job)
      {
        ...
        case Profession.Seducer:
          return "The Seducer - This profession is a master of seduction and can use their beauty and charisma to gain access to valuable targets or extract information.";
        case Profession.Quartermaster:
          return "Quartermaster - The person responsible for managing the gang's resources and ensuring that supplies are distributed fairly. They are responsible for keeping track of the gang's finances, managing the distribution of weapons and equipment, and maintaining the hideout. They must be trusted and loyal, as they are privy to sensitive information about the gang's operations.";
        case Profession.MasterOfDisguise:
          return "Master of Disguise - A specialist in assuming false identities. They are responsible for carrying out complex heists, infiltrating secure locations, and impersonating important figures to gain access to valuable information.";
        case Profession.Lieutenant:
          return "Lieutenant - The second-in-command to the leader, responsible for managing and directing the gang's operations, supervising other gang members, and making important decisions when the leader is absent.";
        default:
          throw new ArgumentException($"Unknown job type {job}");
      }
    }
  }
}